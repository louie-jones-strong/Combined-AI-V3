...
def MakeModel(dataSetManager):
	...
	if runId == None:
		...
		dataSetManager.MetaDataKeySet("AnnRunId", runId)
...
def PredictNetworkStructre(dataSetManager):
	...
	if structreArray == None or inputShape == None:
		...
		dataSetManager.MetaDataKeySet("AnnMoveInputShape", inputShape)
		dataSetManager.MetaDataKeySet("AnnMoveStructreArray", structreArray)
